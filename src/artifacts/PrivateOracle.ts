...
import {
  ...
  export class PrivateOracleContract extends ContractBase {
     ...
     */
    public static deploy(pxe: PXE, payment_token: AztecAddressLike, fee: FieldLike) {
     ...
     */
    public static deployWithPublicKey(pxe: PXE, publicKey: PublicKey, payment_token: AztecAddressLike, fee: FieldLike) {
